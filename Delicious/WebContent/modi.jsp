		...
		<div class="user_main clearfix">
			<div class="user_inner_tab">
				...
				<ul class="user_inner_tab_ul">
					<li><a href="#" class="current link">修改个人资料</a></li>
					<li><a href="editPic.jsp" class="link">修改头像</a></li>
						...
						<form method="POST" action="edit">
							...
							<ul class="useredit_ul clearfix">
								<li><dl class="clearfix">
										<dt>邮箱：</dt>
										<dd class="dd1">
											<span><input type="text" class="text" name="user.email" value="${user.email }"  readonly="readonly" > (未认证，<a
								...
								<li><dl class="clearfix">
										...
										<dd class="dd1" id="editsignname">
											<textarea class="textarea1" name="user.sign">${user.sign }</textarea>
										</dd>
										<dd class="dd2">
