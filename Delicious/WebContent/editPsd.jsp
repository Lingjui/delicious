			...
			<div class="main clearfix">
				...
				<div class="user_main clearfix">
					<div class="user_inner_tab">
						<a href="http://i.meishi.cc/" class="user_backbtn1" title="返回我的空间" alt="返回我的空间"></a>
						<ul class="user_inner_tab_ul">
					<li><a href="edit.jsp" class="link">编辑个人资料</a></li>
					<li><a href="editPic.jsp" class="link">修改头像</a></li>
					<li><a href="editPsd.jsp" class="current link">修改密码</a></li>
								...
								<form method="POST" action="#">
									...
									<li>
										<dl class="clearfix">
											<dt>重复密码：</dt>
											<dd class="dd1">
												<input type="password" name="re_password" class="text">
											</dd>
											<dd class="dd2"></dd>
										</dl>
									</li>
