...
<body>
	...
	<div class="row12">
		<div class="row12_1">
			<img src="${uploadMenu.photo }" />
		</div>
		<div class="row12_2">
			<div class="info1">
				<h2 class="title">
					<a id="tongji_title" title="${uploadMenu.title }的做法" href="#">${uploadMenu.title }</a>
				</h2>
...
.row12_2 .info1 .title {
	...
	-webkit-transition: all ease 0.3s;
				...
				<span class="favbtns"> <a href="#"
					title="${uploadMenu.title }的做法" class="addToFav_con"
					id="addToFav_con">收藏 <span id="f_num">(4272)</span>
				</a>
			...
			<div class="info2">
				<ul class="clearfix">
					<li class="w127"><strong>工艺</strong><a id="tongji_gy" href="#"
						title="${uploadMenu.title }" class="big">${uploadMenu.gongyi }</a></li>
					<li class="w270"><strong>难度</strong>
						<div class="processing_w">
							<span class="icon icon_nd"></span><span
								...
								href="#" title="${uploadMenu.title }的难度" class="small">${uploadMenu.make_diff }</a>
						</div></li>
					<li class="w270 br0"><strong>人数</strong>
						<div class="processing_w">
							<span class="icon icon_rs"></span><span
								class="processing processing_nd9"></span><a id="tongji_rsh"
								href="#" title="${uploadMenu.title }的人数" class="small">${uploadMenu.make_amount }</a>
						</div></li>
					<li class="w127 bb0"><strong>口味</strong><a id="tongji_kw"
						href="javascript:;" title="${uploadMenu.title }的口味" class="big">${uploadMenu.kouwei }</a></li>
					<li class="w270 bb0"><strong>准备时间</strong>
						<div class="processing_w">
							<span class="icon icon_zb"></span><span
								...
								href="#" title="${uploadMenu.title }的准备时间" class="small">${uploadMenu.make_pretime }</a>
						</div></li>
					<li class="w270 bb0 br0"><strong>烹饪时间</strong>
						<div class="processing_w">
							<span class="icon icon_pr"></span><span
								class="processing processing_nd7"></span><a href="#"
								id="tongji_prsj" title="${uploadMenu.title }的烹饪时间" class="small">&lt;${uploadMenu.make_time  }</a>
						</div></li>
				</ul>
			</div>
			<div class="info3">
	...
	<div class="row15">
		<h2 class="cpc_h2">${uploadMenu.title }的做法</h2>
		<div class="editnew edit">
			<div class="content clearfix">
				...
				<div class="c">
					<p>将鸡处理好，洗净沥干水分</p>
					<p>
						<img class="conimg" src="${uploadMenu.photo }" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>炒熟的板栗剥出栗子仁</p>
					<p>
						<img class="conimg" src="images/s2.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				<em class="step">3.</em>
				<div class="c">
					<p>准备好配料，生姜、大蒜、红辣椒以及香料</p>
					<p>
						<img class="conimg" src="images/s3.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>所有材料备好</p>
					<p>
						<img class="conimg" src="images/s4.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>锅里加油烧热，放入姜片里面</p>
					<p>
						<img class="conimg" src="images/s5.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>接着倒入沥干水分的鸡块里面煸炒</p>
					<p>
						<img class="conimg" src="images/s6.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>炒到鸡块水分干一点，表面焦黄色</p>
					<p>
						<img class="conimg" src="images/s7.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>加入啤酒里面</p>
					<p>
						<img class="conimg" src="images/s8.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				...
				<div class="c">
					<p>接着加入香料里面，盖上盖子焖煮</p>
					<p>
						<img class="conimg" src="images/s9.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				<em class="step">10.</em>
				<div class="c">
					<p>煮至10几分钟后，加入板栗，大蒜，红辣椒里面</p>
					<p>
						<img class="conimg" src="images/s10.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				<em class="step">11.</em>
				<div class="c">
					<p>再倒入酱油，鸡精，盐里面，然后盖上盖子继续焖煮</p>
					<p>
						<img class="conimg" src="images/s11.jpg" alt="">
					</p>
				</div>
			</div>
			<div class="content clearfix">
				<em class="step">12.</em>
				<div class="c">
					<p>直到水分收干了，就可以关火出锅了</p>
					<p>
						<img class="conimg" src="images/s12.jpg" alt="">
					</p>
				</div>
			</div>
			<p>
				<img style="margin: 0 0 0 200px;" class="conimg" border="0"
					src="images/s13.jpg">
			</p>
			<p>
				<img style="margin: 0 0 0 200px;" class="conimg" border="0"
			...
			<p style="padding-left: 200px;">
				1、板栗是提前炒熟的，所以烧的时候不用太早放进去； <br> 2、香料里面有桂皮、八角、白豆蔻、陈皮、砂仁、花椒、白芷。
			</p>
		</div>
	</div>
	<div class="clear"></div>
