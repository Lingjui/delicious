...
<html>
	...
	<body>
		...
		<div class="row7">
			<h3 class="l_title">
				<span class="left_t"></span>登录舌尖·美味<span class="right_t"></span>
			</h3>
			<div class="load_icon">
				<div class="circle1">
					<span class="icon">
			...
			<div class="loadbox">
				<div class="login">
					<form name="frm" action="login" method="post">
						<div class="loginitem">
							<input type="text" id="text" placeholder="  请输入手机号/邮箱/昵称" name="user.username">
						</div>
						<div class="loginitem">
						...
						<div class="loginitem" style="text-align: center;">
							<input type="submit" class="submit" value="登录" onclick="return r()">
						</div>
					</form>
				</div>
			</div>
			<h5 class="t_title" style="margin-top: 20px;"><a href="zhuce.jsp">还没有账号？免费注册！</a></h5>
		</div>
		<div class="clear">
